...
.ki_gi:    db EKANS, CATERPIE, GYARADOS, RAPIDASH, NINETALES, GIRAFARIG, EKANS, KINGDRA, KINGLER, -1
...
.shi_ji:   db SEADRA, EKANS, VAPOREON, DEWGONG, -1
...
.to_do:    db EKANS, EKANS, SMEARGLE, KOFFING, TENTACRUEL, EKANS, EKANS, EKANS, METAPOD, EKANS, -1
...
.ne:       db EKANS, EKANS, -1
.no:       db DUNSPARCE, -1
.ha_ba_pa: db SEEL, STEELIX, TYPHLOSION, DRAGONAIR, BUTTERFREE, SCIZOR, HOPPIP, EKANS, EKANS, EKANS, EKANS, EKANS, TYROGUE, EKANS, TYRANITAR, -1
...
.ho_bo_po: db EKANS, EKANS, PIDGEY, PONYTA, SKIPLOOM, PORYGON, PORYGON2, -1
