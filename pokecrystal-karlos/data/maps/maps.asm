...
MapGroup_HeraldCove:
	...
	map HeraldCove, TILESET_JOHTO, TOWN, LANDMARK_HERALD_COVE, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map HeraldRoute, TILESET_JOHTO, ROUTE, LANDMARK_HERALD_ROUTE, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map HeraldLab, TILESET_LAB, INDOOR, LANDMARK_HERALD_COVE, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map HeraldHouse, TILESET_HOUSE, INDOOR, LANDMARK_HERALD_COVE, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map HeraldPort, TILESET_PORT, INDOOR, LANDMARK_HERALD_COVE, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
