...
YoungsterGroup:
	...
	db  26, PIDGEY, HAIL, AURORA_BEAM, SURF, REST
...
SchoolboyGroup:
	...
	db 35, PIDGEY,   TAIL_WHIP, POUND, AMNESIA, EARTHQUAKE
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 31, PIDGEY,   WATER_GUN, POUND, AMNESIA, EARTHQUAKE
...
CooltrainerFGroup:
	...
	db 36, PIDGEY,   STOMP, POUND, FURY_ATTACK, AGILITY
	db -1 ; end
	...
	; COOLTRAINERF (12)
	db "BETH@", TRAINERTYPE_MOVES
	db 39, PIDGEY,   STOMP, POUND, FURY_ATTACK, AGILITY
	db -1 ; end
	...
	db 43, PIDGEY,   FOCUS_BAND,   STOMP, POUND, FURY_ATTACK, FIRE_BLAST
	db -1 ; end
...
PicnickerGroup:
	...
	db 36, PIDGEY,     DOUBLE_TEAM, STOMP, POUND, SUNNY_DAY
