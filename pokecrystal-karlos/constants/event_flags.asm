...
; Sevii Islands: next 48 events
	const EVENT_PLAYERS_HOUSE_RIVAL
	const EVENT_GOT_A_POKEMON_FROM_CELIO
	const EVENT_GOT_EKANS_FROM_CELIO
	const EVENT_GOT_HOUNDOUR_FROM_CELIO
	const EVENT_GOT_BALTOY_FROM_CELIO
